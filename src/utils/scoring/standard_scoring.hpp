...
#ifndef STANDARD_SCORING_HPP
#define STANDARD_SCORING_HPP

#include "utils/scoring/scoring.hpp"

class StandardScoring: public Scoring
{
public:
    ...
    bool isStandard() const final { return true; }
