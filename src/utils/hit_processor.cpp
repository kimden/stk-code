...
namespace
{
    ...
    Attachment::AttachmentType getAttachment(AbstractKart* kart)
    {
...
void HitProcessor::handleTeammateHits()
{
    ...
    AbstractKart *owner = World::getWorld()->getKart(m_current_item_owner_id);
...
void HitProcessor::processTeammateHit(AbstractKart* owner,
...
void HitProcessor::punishKart(AbstractKart* kart, float value, float value2)
{
