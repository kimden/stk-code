...
void TrackInfoScreen::init()
{
    ...
    RaceManager::get()->setFuelAndQueueInfo(m_fuel_spinner->getValue(), m_allowed_compound_1_spinner->getValue(), m_allowed_compound_2_spinner->getValue(), m_allowed_compound_3_spinner->getValue());
